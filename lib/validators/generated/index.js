...
exports.isClassInstanceVariableDeclaration = isClassInstanceVariableDeclaration;
exports.isClassInstanceVariableDeclarator = isClassInstanceVariableDeclarator;
exports.isClassVariableDeclaration = isClassVariableDeclaration;
...
exports.isInstanceVariableName = isInstanceVariableName;
...
exports.isJSX = isJSX;
exports.isInstanceVariableDeclaration = isInstanceVariableDeclaration;
exports.isInstanceVariable = isInstanceVariable;
exports.isInstanceVariableDeclarator = isInstanceVariableDeclarator;
...
function isClassInstanceVariableDeclaration(node, opts) {
  if (!node) return false;
  const nodeType = node.type;
...
function isClassInstanceVariableDeclarator(node, opts) {
  if (!node) return false;
  const nodeType = node.type;
...
function isClassVariableDeclaration(node, opts) {
  if (!node) return false;
  const nodeType = node.type;
...
function isInstanceVariableName(node, opts) {
  if (!node) return false;
  const nodeType = node.type;
...
function isInstanceVariableDeclaration(node, opts) {
  if (!node) return false;
  const nodeType = node.type;

  if (nodeType === "InstanceVariableDeclaration" || "ClassInstanceVariableDeclaration" === nodeType) {
    if (typeof opts === "undefined") {
      return true;
    } else {
      return (0, _shallowEqual.default)(node, opts);
...
function isInstanceVariable(node, opts) {
  if (!node) return false;
  const nodeType = node.type;

  if (nodeType === "InstanceVariable" || "ClassInstanceVariableDeclarator" === nodeType) {
    if (typeof opts === "undefined") {
      return true;
    } else {
      return (0, _shallowEqual.default)(node, opts);
...
function isInstanceVariableDeclarator(node, opts) {
  if (!node) return false;
  const nodeType = node.type;

  if (nodeType === "InstanceVariableDeclarator" || "ClassInstanceVariableDeclarator" === nodeType) {
    if (typeof opts === "undefined") {
      return true;
    } else {
      return (0, _shallowEqual.default)(node, opts);
