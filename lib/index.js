...
var classes11 = (function (superClass) {
  return function (_superClass) {
    ...
    _proto.parseClassInstanceVariable = function parseClassInstanceVariable(node) {
    ...
    _proto.parseClassMember = function parseClassMember(classBody, member, state) {
      ...
      if (type === types._var || type === types._let || type === types._const) {
        var node = this.startNode();
        this.parseVarStatement(node, this.state.type);
        node.type = "ClassInstanceVariableDeclaration";
        node.declarations = node.declarations.map(function (_ref) {
          var id = _ref.id,
              decl = _objectWithoutPropertiesLoose(_ref, ["id"]);

          var instanceVar = Object.assign({}, decl, {
            key: id
          });

          _this.parseClassInstanceVariable(instanceVar);
...
var Tokenizer = function (_LocationParser) {
  ...
  _proto.getTokenFromCode = function getTokenFromCode(code) {
    switch (code) {
      ...
      case 58:
        if ((this.hasPlugin("functionBind") || this.hasPlugin("classes1.1")) && this.input.charCodeAt(this.state.pos + 1) === 58) {
...
var mixinPluginNames = ["estree", "classes1.1", "jsx", "flow", "typescript"];
var mixinPlugins = {
  estree: estree,
  "classes1.1": classes11,
  jsx: jsx,
  flow: flow,
