...
var _classMembers = _interopRequireDefault(require("./plugins/class-members"));
...
const mixinPluginNames = ["estree", "classMembers", "jsx", "flow", "typescript"];
exports.mixinPluginNames = mixinPluginNames;
const mixinPlugins = {
  estree: _estree.default,
  classMembers: _classMembers.default,
  jsx: _jsx.default,
  flow: _flow.default,
